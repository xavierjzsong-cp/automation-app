...
src/adapters/ht_adapter.py
    HT adapter interface with mapped-data validation and Playwright browser lifecycle management.
...
scripts/check_ht_adapter.py
    Smoke and repeatability check for HT adapter validation and replaceable browser lifecycle management.
