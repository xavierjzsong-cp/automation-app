...
src/adapters/ht_adapter.py
    HT adapter with mapped-data validation, Playwright browser lifecycle management, Kendo search selection, report opening/readiness, and datasheet value extraction.
...
scripts/check_ht_adapter.py
    Smoke and repeatability check for HT adapter selection, report opening, iframe readiness, datasheet extraction, failure handling, mapping, timeouts, validation, and replaceable browser lifecycle management.
