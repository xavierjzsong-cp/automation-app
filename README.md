...
src/adapters/ht_adapter.py
    HT adapter with mapped-data validation, Playwright browser lifecycle management, Kendo search selection, and datasheet report opening/readiness.
...
scripts/check_ht_adapter.py
    Smoke and repeatability check for HT adapter selection and report-opening orchestration, iframe readiness, failure handling, mapping, timeout handling, validation, and replaceable browser lifecycle management.
